...
This prototype includes generated click assets so the project is self-contained. Replace the WAV files in `Sources/MechaKeys/Resources` with licensed recordings for production sound quality.
